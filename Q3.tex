\begin{enumerate}[label=(\alph*)]
    ...
    \]
    \[
    = \frac{1/5}{2i(1 - \sqrt{5})(1 + \sqrt{5})}
    \]
    \[
    = \frac{1}{10i(1-5)} = -\frac{1}{40i} = \frac{i}{40}
    \]
    and therefore,
    \[
    \Res(f,-i/\sqrt{5}) = -\frac{i}{40}
    \]
    for the same reason.
    ...
    We have from (a),
    \[
    S = \Res(f,i) + \Res(f,i/\sqrt{5}) = -\frac{i}{8} + \frac{i}{40} = -\frac{4i}{40} = -\frac{i}{10}
    \]
    Therefore the solution to the integral is,
    \[
    \int_{-\infty}^{\infty} \frac{p(t)}{q(t)}\dd t = \frac{\pi}{5}
    \]
\end{enumerate}