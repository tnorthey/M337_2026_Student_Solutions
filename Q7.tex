...
\item
    ...
    \vs \\
    I'd also wonder if it's worth including a sequence of points, as in the solution Spec 1 Q7(a)(ii)? Eg, for $n \in \N, \; (n+2)i \in C$, and  $|f\big((n+2)i\big)| = \left| \exp\dfrac{n+3}{(n+3)^2} \right| \left| \exp i(0) \right| = \exp(n+3) \to \infty $ as $ n \to \infty $, 
    \\ -- Donach}
    \end{enumerate}
